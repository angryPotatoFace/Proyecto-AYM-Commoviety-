<template >
  ...
  <section class="registration">
    ...
    <p>Por favor completa los siguiente campos para registrarse</p>
      ...
      <!-- FORMULARIO -->
      <vue-form class="row " :state="formstate" @submit.prevent="enviar()" :style="{ margin: '0 15rem' }">
        <div class="col">
          <div >
                  ...
                  <validate tag="div">  
                    ...
                    <input 
                      ...
                      <field-messages name="usuario" show="$dirty">
                        ...
                        <div class="alert alert-danger mt-1" v-if="formData.usuario.length==datoMaxLength">
                          La cantidad maxima de caracteres es {{datoMaxLength}}.
                        </div>
                      </field-messages>
                  </validate>
                  ...
                  <validate tag="div">  
                    ...
                    <input 
                      ...
                      <field-messages name="email" show="$dirty">
                        ...
                        <div class="alert alert-danger mt-1" v-if="formData.email.length==datoMaxLength">
                          La cantidad maxima de caracteres es {{datoMaxLength}}.
                        </div>
                      </field-messages>
                  </validate>
        ...
        <div class="col-3">
          <svg style="color:#F48660" xmlns="http://www.w3.org/2000/svg" width="200" height="200" fill="currentColor" class="bi bi-file-person-fill" viewBox="0 0 16 16">
            <path d="M12 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2zm-1 7a3 3 0 1 1-6 0 3 3 0 0 1 6 0zm-3 4c2.623 0 4.146.826 5 1.755V14a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1v-1.245C3.854 11.825 5.377 11 8 11z"/>
          </svg>
        </div>
        <button class="btn btn-danger col-12 mt-5" 
