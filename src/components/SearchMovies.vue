<template>
  ...
  <section class="src-components-movies">
    ...
    <div class="borde-buscador" style="background:#F48660">
        <br>
        <input type="text" class="form-control" v-model="busquedaPorTitulo"
        placeholder="Ingresar el titulo de la pelicula...">
      <br>
    </div>
    <br>    
    <h1 style="color:crimson">TITULOS</h1>
    <div class="container">
      ...
      <div v-else>
      <div class="row">
        <div v-for="(movie,index) in peliculasFiltradas" :key="index" class="col-sm-4 mr-6">
